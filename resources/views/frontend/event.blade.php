                                ...
                                <div class="blog__content p-0">
                                    ...
                                    <div class="tags-share mt-40">
                                        ...
                                        <div class="share">
                                            ...
                                            <a class="" href="#0"><i class="fa-brands fa-twitter"></i></a>
                            ...
                            <div class="blog-single__right-item">
                                ...
                                <div class="item shadow mb-30">
                                    ...
                                    <ul class="single-post">
                                       ...
                                       <li>
                                        <img src="{{ asset('assets/images/banner/' .$recent->event_banner) }}" alt="image" style="width: 50%">
                                        <div class="con">
                                            <h6><a href="{{ route("events.details",$recent->slug) }}" class="primary-hover">
                                            {{ $recent->title }}
                                            </a></h6>
                                            <span></span>{{ Carbon\Carbon::parse($recent->created_at)->diffForHumans() }}
                                        </div>
                                    </li>
                                       @endforeach
