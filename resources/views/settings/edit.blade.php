...
{{-- 				
											...
											<div class="form-group">
												<label for="telegram_group" class="required">{{__('Telegram Group')}}:</label>
												<input type="text" name="telegram_group" id="telegram_group" class="form-control @error('telegram_group') form-control-error @enderror" required="required" value="{{$setting->telegram_group}}">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="card">
														<div class="card-body text-center">
															<div class="form-group">
																<label for="website_favicon" class="required">{{__('Website Favicon')}}:</label>
																<div class="">
																	@if(!empty($setting->website_favicon))
																		<img src="{{ asset("images/settings/$setting->website_favicon") }}" alt="..." id="website_favicon" class="img-thumbnail rounded mb-3"  >
																	@else
																		<img src="" alt="..." id="website_favicon" class="img-thumbnail rounded mb-3" >
																	@endif
